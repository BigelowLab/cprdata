...
The dataset contains both zooplankton and phytoplankton data from the Mid-Atlantic Bight and Gulf of Maine regions.  We regularily access to the zooplankton data, but it is easy to switch to phytoplankton.  We can read the data in its "raw" state as a simple table or transformed into a [sf](https://r-spatial.github.io/sf/) POINT table.
